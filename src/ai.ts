...
const intro = `Create a summary of the diff below the template, and explain what changes and why depending only on the actual diff. Wrap the description to 80 characters. Use the following format of conventional-commits to summarize it:
